...
Parsing throughput on my test machine (2Ghz Core 2 Duo, 4GB RAM, Ruby 1.9) is roughly 1.6 Megabytes/sec. Benchmarking Sexpistol against other popular S-Expression parser gems shows that it is roughly 7-8x faster than the nearest competitor.
